...
Use `.Codex/skills/entire-external-agent/research.md`.
...
Use `.Codex/skills/entire-external-agent/write-tests.md`.
...
Use `.Codex/skills/entire-external-agent/implement.md`.
